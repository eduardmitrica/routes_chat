...
/// `participantIds.join('_')`, the format compositeId produces.
 List<String> get participantIds;@MessageDataTransferObjectConverter() MessageDataTransferObject get lastMessage;/// Every generation of the chat's key, by number, each sealed to the
...
@KeyGenerationsConverter() Map<int, KeyGeneration> get keyGenerations;/// The generation new messages are encrypted under: the highest.
 int get currentKeyGeneration;@ServerTimestampConverter() FieldValue get serverTimeStamp;
...
int get hashCode {
  final _this = this as ChatDataTransferObject;
  return Object.hash(runtimeType,_this.id,const DeepCollectionEquality().hash(_this.participants),const DeepCollectionEquality().hash(_this.participantIds),_this.lastMessage,const DeepCollectionEquality().hash(_this.keyGenerations),_this.currentKeyGeneration,_this.serverTimeStamp);
}

@override
String toString() {
  final _this = this as ChatDataTransferObject;
  return 'ChatDataTransferObject(id: ${_this.id}, participants: ${_this.participants}, participantIds: ${_this.participantIds}, lastMessage: ${_this.lastMessage}, keyGenerations: ${_this.keyGenerations}, currentKeyGeneration: ${_this.currentKeyGeneration}, serverTimeStamp: ${_this.serverTimeStamp})';
}
...
@useResult
$Res call({
@JsonKey(includeToJson: false, includeFromJson: false) String? id, List<Map<String, String>> participants, List<String> participantIds,@MessageDataTransferObjectConverter() MessageDataTransferObject lastMessage,@KeyGenerationsConverter() Map<int, KeyGeneration> keyGenerations, int currentKeyGeneration,@ServerTimestampConverter() FieldValue serverTimeStamp
});
...
/// Create a copy of ChatDataTransferObject
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? participants = null,Object? participantIds = null,Object? lastMessage = null,Object? keyGenerations = null,Object? currentKeyGeneration = null,Object? serverTimeStamp = null,}) {
...
as MessageDataTransferObject,keyGenerations: null == keyGenerations ? _self.keyGenerations : keyGenerations // ignore: cast_nullable_to_non_nullable
as Map<int, KeyGeneration>,currentKeyGeneration: null == currentKeyGeneration ? _self.currentKeyGeneration : currentKeyGeneration // ignore: cast_nullable_to_non_nullable
as int,serverTimeStamp: null == serverTimeStamp ? _self.serverTimeStamp : serverTimeStamp // ignore: cast_nullable_to_non_nullable
as FieldValue,
  ));
}
/// Create a copy of ChatDataTransferObject
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false, includeFromJson: false)  String? id,  List<Map<String, String>> participants,  List<String> participantIds, @MessageDataTransferObjectConverter()  MessageDataTransferObject lastMessage, @KeyGenerationsConverter()  Map<int, KeyGeneration> keyGenerations,  int currentKeyGeneration, @ServerTimestampConverter()  FieldValue serverTimeStamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatDataTransferObject() when $default != null:
return $default(_that.id,_that.participants,_that.participantIds,_that.lastMessage,_that.keyGenerations,_that.currentKeyGeneration,_that.serverTimeStamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false, includeFromJson: false)  String? id,  List<Map<String, String>> participants,  List<String> participantIds, @MessageDataTransferObjectConverter()  MessageDataTransferObject lastMessage, @KeyGenerationsConverter()  Map<int, KeyGeneration> keyGenerations,  int currentKeyGeneration, @ServerTimestampConverter()  FieldValue serverTimeStamp)  $default,) {final _that = this;
switch (_that) {
case _ChatDataTransferObject():
return $default(_that.id,_that.participants,_that.participantIds,_that.lastMessage,_that.keyGenerations,_that.currentKeyGeneration,_that.serverTimeStamp);case _:
  throw StateError('Unexpected subclass');
...
class _ChatDataTransferObject extends ChatDataTransferObject {
  const _ChatDataTransferObject({@JsonKey(includeToJson: false, includeFromJson: false) this.id, required  List<Map<String, String>> participants, required  List<String> participantIds, @MessageDataTransferObjectConverter() required this.lastMessage, @KeyGenerationsConverter() required  Map<int, KeyGeneration> keyGenerations, required this.currentKeyGeneration, @ServerTimestampConverter() required this.serverTimeStamp}): _participants = participants,_participantIds = participantIds,_keyGenerations = keyGenerations,super._();
...
/// resets their keys adds the next. Generations are never changed or
/// removed. See docs/e2ee.md.
 final  Map<int, KeyGeneration> _keyGenerations;
/// Every generation of the chat's key, by number, each sealed to the
/// participants. A chat starts with generation 1; a participant who
/// resets their keys adds the next. Generations are never changed or
/// removed. See docs/e2ee.md.
@override@KeyGenerationsConverter() Map<int, KeyGeneration> get keyGenerations {
  if (_keyGenerations is EqualUnmodifiableMapView) return _keyGenerations;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_keyGenerations);
}

/// The generation new messages are encrypted under: the highest.
@override final  int currentKeyGeneration;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatDataTransferObject&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.participants, _participants)&&const DeepCollectionEquality().equals(other.participantIds, _participantIds)&&(identical(other.lastMessage, lastMessage) || other.lastMessage == lastMessage)&&const DeepCollectionEquality().equals(other.keyGenerations, _keyGenerations)&&(identical(other.currentKeyGeneration, currentKeyGeneration) || other.currentKeyGeneration == currentKeyGeneration)&&(identical(other.serverTimeStamp, serverTimeStamp) || other.serverTimeStamp == serverTimeStamp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_participants),const DeepCollectionEquality().hash(_participantIds),lastMessage,const DeepCollectionEquality().hash(_keyGenerations),currentKeyGeneration,serverTimeStamp);
}

@override
String toString() {
    return 'ChatDataTransferObject(id: $id, participants: $participants, participantIds: $participantIds, lastMessage: $lastMessage, keyGenerations: $keyGenerations, currentKeyGeneration: $currentKeyGeneration, serverTimeStamp: $serverTimeStamp)';
}
...
/// Create a copy of ChatDataTransferObject
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? participants = null,Object? participantIds = null,Object? lastMessage = null,Object? keyGenerations = null,Object? currentKeyGeneration = null,Object? serverTimeStamp = null,}) {
...
as List<String>,lastMessage: null == lastMessage ? _self.lastMessage : lastMessage // ignore: cast_nullable_to_non_nullable
as MessageDataTransferObject,keyGenerations: null == keyGenerations ? _self._keyGenerations : keyGenerations // ignore: cast_nullable_to_non_nullable
as Map<int, KeyGeneration>,currentKeyGeneration: null == currentKeyGeneration ? _self.currentKeyGeneration : currentKeyGeneration // ignore: cast_nullable_to_non_nullable
as int,serverTimeStamp: null == serverTimeStamp ? _self.serverTimeStamp : serverTimeStamp // ignore: cast_nullable_to_non_nullable
as FieldValue,
  ));
