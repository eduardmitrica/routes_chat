...
import 'application/chats/friends_watcher/friends_watcher_bloc.dart' as _i25;
...
import 'domain/chats/chat_repository_interface.dart' as _i9;
import 'domain/friend_requests/friend_requests_repository_interface.dart'
    as _i13;
import 'domain/shared/user/user_repository_interface.dart' as _i11;
...
import 'infrastructure/shared/user/user_repository.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.IUserRepository>(() => _i12.UserFacade(
    ...
    gh.factory<_i22.UsersWatcherBloc>(
        () => _i22.UsersWatcherBloc(gh<_i11.IUserRepository>()));
    gh.factory<_i23.UserFormBloc>(
        () => _i23.UserFormBloc(gh<_i11.IUserRepository>()));
    gh.factory<_i24.UserWatcherBloc>(
        () => _i24.UserWatcherBloc(gh<_i11.IUserRepository>()));
    gh.factory<_i25.FriendsWatcherBloc>(() => _i25.FriendsWatcherBloc(
          gh<_i13.IFriendRequestsRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i26.PendingFriendRequestsWatcherBloc>(() =>
        _i26.PendingFriendRequestsWatcherBloc(
            gh<_i13.IFriendRequestsRepository>()));
    gh.factory<_i27.ReceivedFriendRequestsWatcherBloc>(() =>
        _i27.ReceivedFriendRequestsWatcherBloc(
            gh<_i13.IFriendRequestsRepository>()));
    return this;
  }
}
